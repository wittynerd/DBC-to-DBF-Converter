...
#Add dbc,dbf to supported format manually

##loadedFormats = ['csv', 'dbc', 'dbf', 'json', 'sym', 'scapy', 'wireshark']
##supportedFormats = {'csv': ['dump'], 'dbc': ['load', 'dump'], 'dbf': ['load', 'dump'], 'json': ['load', 'dump'], 'sym': ['load', 'dump'], 'scapy': ['dump', 'extension'], 'wireshark': ['dump', 'extension']}
##extensionMapping = {'csv': 'csv', 'dbc': 'dbc', 'dbf': 'dbf', 'json': 'json', 'sym': 'sym', 'scapy': 'py', 'wireshark': 'lua'}

loadedFormats = ['dbc', 'dbf']
supportedFormats = {'dbc': ['load', 'dump'], 'dbf': ['load', 'dump']}
extensionMapping = {'dbc': 'dbc', 'dbf': 'dbf'}
...
##                print(extension, supportedFormats[supportedImportType])
##                print(path.lower(), path.lower().endswith(extension))
##                print("load" in supportedFormats[supportedImportType])
##                print("\n")
...
##            print(extension)
##            print(path.lower(), path.lower().endswith("." + extension))
##            print("dump" in supportedFormats[key])
##            print("\n")
